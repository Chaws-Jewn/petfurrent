...
<div class="account-info container-fluid" style="background: white;margin: 20px; padding: 20px;">
    ...
    <div class="grid-container">
        ...
        <!-- Add the following lines to display additional information -->
        ...
        <!-- Fur Parent Information Part -->
        <!-- <div class="customer-info container-fluid" style="background-color: white; margin: 20px; padding: 20px;">
            <h2>Fur Parent Information</h2>
            <h6>Informations from the Adoption form.</h6>
            <hr>
            <div class="grid-container"> -->
                <!-- <div class="grid-item bold">Customer Name:</div>
                <div class="grid-item">{{ $adopt->first_name }} {{ $adopt->last_name }}</div> -->
                <!-- <div class="grid-item bold">Email:</div>
                <div class="grid-item">{{ $adopt->email_address }}</div> -->
            <!-- </div>
        </div> -->

        <!-- Fur Parent Contact Information Part -->
    ...
    <div class="grid-item">{{ $adopt->email_address }}</div>
        ...
        <div class="dog-info container-fluid" style="background: white; margin: 20px; padding: 20px;">
            ...
            <div class="grid-container">
                ...
                <div class="grid-item">
                    <img src="{{ asset('dog/' . $adopt->dog->image) }}" alt="Dog Image"
                        style="max-width: 70%; height: 70%;">
                </div>
                @else
...
<!-- Existing code for Adopted Dog Information Part -->
<hr>
